<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeFile="UploadModel_v2.aspx.cs" Inherits="UploadModel" %>
  ...
  <div class="full-frame-holder">
     ...
     <div id="MainContainer">
         <div id="UploadContainer">
            ...
            <div id="act-upload" style="color:#f6af25;font-size:18px;cursor:pointer;"><span>Upload 3D Library.</span></div>
            ...
            <div style="padding-left: 0px;padding-top: 10px;">
                ...
                <asp:FileUpload  class="form-control" id="FileUpload1" runat="server"></asp:FileUpload>
                 <button  style="margin-top:10px;background-color:#0c2a51;background-color:#0c2a51;" class="btn btn-primary" id="Uploadbtn">Upload</button>
            </div>
    ...
    <script>
        ...
        $("#act-upload").click(function () {
            window.location.href = "UploadModel.aspx"
                    ...
                    if (fileName) {
                        ...
                        if (ext == "ifc" || ext == "rvt") {
                            ...
                            setTimeout(function () {
                                $("#UploadContainer").hide();
                                $(".full-frame-holder").show();
                                $("#data-frame").attr("src",'library_model_data_collect.aspx?flag=0&libid=11&isupdate=1');
                                $("#loader").hide();
                            }, 2500);
                            return false;
                        }else{
